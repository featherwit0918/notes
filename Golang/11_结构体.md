...
p2.age = 28
p2.city = "上海"
fmt.Printf("p2=%#v\n", p2) //p2=&main.person{name:"张三", city:"上海", age:28}
```
...
fmt.Printf("p5=%#v\n", p5) //p5=main.person{name:"张三", city:"北京", age:18}
```
...
fmt.Printf("p6=%#v\n", p6) //p6=&main.person{name:"张三", city:"北京", age:18}
```
...
Go语言的结构体没有构造函数, 我们可以自己实现一个构造函数。 例如
...
```go
p9 := newPerson("张三", "湖南", 90)
fmt.Printf("%#v\n", p9) //&main.person{name:"张三", city:"湖南", age:90}
```
...
func main() {
	...
	fmt.Printf("user1=%#v\n", user1)//user1=main.User{Name:"张三", Gender:"男", Address:main.Address{Province:"湖南", City:"怀化"}}
}
```
...
func main() {
	...
	user2.Name = "张三"
	user2.Gender = "男"
	user2.Address.Province = "湖南"    // 匿名字段默认使用类型名作为字段名
	user2.City = "怀化"                // 匿名字段可以省略
	fmt.Printf("user2=%#v\n", user2) //user2=main.User{Name:"张三", Gender:"男", Address:main.Address{Province:"湖南", City:"怀化"}}
}
```
